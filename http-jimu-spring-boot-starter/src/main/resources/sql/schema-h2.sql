-- H2 schema for HTTP Jimu（含中文表/字段注释）
...
CREATE TABLE IF NOT EXISTS http_jimu_config (
    ...
    query_params CLOB,
    body_config CLOB,
    body_type VARCHAR(20) DEFAULT 'none' NOT NULL,
    body_raw_type VARCHAR(20) DEFAULT 'json' NOT NULL,
    cron_config VARCHAR(500),
    enable_job BOOLEAN DEFAULT FALSE NOT NULL,
    params_config CLOB,
    steps_config CLOB,
    pool_id VARCHAR(64),
    connect_timeout INT,
...
ALTER TABLE http_jimu_config ADD COLUMN IF NOT EXISTS exposed_mapping_config CLOB;
...
CREATE TABLE IF NOT EXISTS http_jimu_step (
    ...
    target VARCHAR(32) DEFAULT 'BODY' NOT NULL,
    script_content CLOB,
    config_json CLOB,
    input_schema CLOB,
    output_schema CLOB,
...
CREATE TABLE IF NOT EXISTS http_jimu_pool (
    ...
    steps_config CLOB,
    max_idle_connections INT DEFAULT 5 NOT NULL,
    keep_alive_duration BIGINT DEFAULT 300000 NOT NULL,
    connect_timeout INT DEFAULT 10000 NOT NULL,
    read_timeout INT DEFAULT 10000 NOT NULL,
    write_timeout INT DEFAULT 10000 NOT NULL,
    call_timeout INT DEFAULT 0 NOT NULL,
...
ALTER TABLE http_jimu_pool ADD COLUMN IF NOT EXISTS steps_config CLOB;
